 ...
 */
void run_contest(int board_size, int num_games, Connection connect, string socket_name, vector<tuple<string, string>> &execs, int delay, bool display_now);
...
Match handle_match_process(ContestMatch &cmatch, int board_size, int num_games, Connection connect, string socket_name, int delay, bool display_now);
 ...
 */
int run_game(Match *match, Connection *connect, Board &boards, char *msg1, char *msg2, int num_ships, int max_ship_len, int min_ship_len);
 ...
 * @return 0 if all is good, -1 if player1 failed, -2 if player2 failed, -3 if both failed.
 */
int handle_ship_placement(Match *match, Connection *connect, Board &boards, char *msg1, char *msg2);
 ...
 */
ErrorNum validate_ship_placement(char **board, int board_size, int ship_length);
 ...
 * @return 0 if all is good, -1 if player1 failed, -2 if player2 failed, -3 if both failed.
 */
int handle_shot_placement(Match *match, Connection *connect, Board &boards, char *msg1, char *msg2);
 ...
 */
ErrorNum validate_shot_placement(int board_size);
 ...
 */
void get_shot_value(char **opponent_board);
 ...
 * @return 0 if all is good, -1 if player1 failed, -2 if player2 failed, -3 if both failed.
 */
int check_ships_alive(Match *match, Connection *connect, char *msg, char **board, PlayerNum player);
 ...
 */
void calculate_winner(Match *match);
